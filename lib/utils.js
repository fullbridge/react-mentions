...
module.exports = {
  ...
  getFilteredProps: function getFilteredProps(props) {
    var keysToFilter = ['query', 'index', 'descriptor', 'suggestion', 'focused', 'markup', 'displayTransform', 'singleLine', 'textAreaClassName', 'style', 'suggestionClassName', 'suggestionsListClassName', 'focusedSuggestionClassName'];
    var filteredProps = {};
