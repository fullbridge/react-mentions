...
module.exports = {
  ...
  getMentions: function getMentions(value, markup, displayTransform) {
    var mentions = [];
  ...
  getEndOfLastMention: function getEndOfLastMention(value, markup, displayTransform) {
    var mentions = this.getMentions(value, markup, displayTransform);
  ...
  getFilteredProps: function getFilteredProps(props) {
    var keysToFilter = ['query', 'index', 'descriptor', 'suggestion', 'focused', 'markup', 'displayTransform', 'singleLine', 'textAreaClassName', 'style', 'suggestionClassName', 'suggestionsListClassName', 'focusedSuggestionClassName', 'mainDivClassName', 'suggestionsListWrapperDivClassName'];
    var filteredProps = {};
