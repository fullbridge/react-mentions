  ...
  (0, _createClass3.default)(MentionsInput, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: this.props.mainDivClassName, ref: 'container' },
        this.renderControl(),
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderControl = function () {
    var singleLine = _this2.props.singleLine;
  ...
  this.renderTextarea = function (props) {
    var filteredProps = _utils2.default.getFilteredProps(props);

    return _react2.default.createElement(_reactAutosizeTextarea2.default, (0, _extends3.default)({
      ref: 'input'
    }, filteredProps, {
  ...
  this.renderSuggestionsOverlay = function () {
    ...
    , { focusedSuggestionClassName: _this2.props.focusedSuggestionClassName,
      suggestionsListClassName: _this2.props.suggestionsListClassName,
      suggestionsListWrapperDivClassName: _this2.props.suggestionsListWrapperDivClassName,
      suggestionClassName: _this2.props.suggestionClassName,
  ...
  this.executeOnChange = function (event) {
    ...
    if (_this2.props.onChange) {
      ...
      return (_props3 = _this2.props).onChange.apply(_props3, [event].concat(args));
    }
